...
result = set(vlans) #преобразуем список list во множество set 
                    #оставляем только уникальные значения
result = sorted(result) #сортируем по возрастанию
print(result)

'''
функция sorted сортирует элементы списка по возрастанию 
и возвращает новый список с отсортированными элементами:
